...
namespace ICTEAS.WinForms.Helpers
{
    ...
    public class Office2007ColorTable : ProfessionalColorTable
    {
        ...
        private static Color _toolStripBegin = DesignHelper.DoGetColorFromHash("Menu_toolStripBegin");// Color.FromArgb(204, 204, 204);
        private static Color _toolStripEnd = DesignHelper.DoGetColorFromHash("Menu_toolStripEnd");//= Color.FromArgb(153, 153, 153);
        private static Color _toolStripMiddle = DesignHelper.DoGetColorFromHash("Menu_toolStripMiddle");// Color.FromArgb(204, 204, 204);

        private static Color _buttonPressedBegin = DesignHelper.DoGetColorFromHash("Menu_buttonPressedBegin");// Color.FromArgb(204, 204, 204);//CHECK//Combobox//==
        private static Color _buttonPressedEnd = DesignHelper.DoGetColorFromHash("Menu_buttonPressedEnd");//Color.FromArgb(133, 133, 133);//CHECK//==
        private static Color _buttonPressedMiddle = DesignHelper.DoGetColorFromHash("Menu_buttonPressedMiddle");// Color.FromArgb(204, 204, 204);//==

        private static Color _buttonSelectedBegin = DesignHelper.DoGetColorFromHash("Menu_buttonSelectedBegin");// Color.FromArgb(153, 153, 153);//==
        private static Color _buttonSelectedEnd = DesignHelper.DoGetColorFromHash("Menu_buttonSelectedEnd");//Color.FromArgb(204, 204, 204);//==
        private static Color _buttonSelectedMiddle = DesignHelper.DoGetColorFromHash("Menu_buttonSelectedMiddle");//Color.FromArgb(153, 153, 153);//==

        private static Color _menuItemSelectedBegin = DesignHelper.DoGetColorFromHash("Menu_menuItemSelectedBegin");// Color.FromArgb(204, 204, 204);
        private static Color _menuItemSelectedEnd = DesignHelper.DoGetColorFromHash("Menu_menuItemSelectedEnd");// Color.FromArgb(204, 204, 204);

        private static Color _checkBack = DesignHelper.DoGetColorFromHash("Menu_checkBack");// Color.FromArgb(204, 204, 204);
        //private static Color _checkBack = Color.FromArgb(255, 227, 149);// CHANGED
        private static Color _gripDark = DesignHelper.DoGetColorFromHash("Menu_gripDark");// Color.FromArgb(111, 157, 217);
        private static Color _gripLight = DesignHelper.DoGetColorFromHash("Menu_gripLight");// Color.FromArgb(255, 255, 255);
        private static Color _imageMargin = DesignHelper.DoGetColorFromHash("Menu_imageMargin");// Color.FromArgb(204, 204, 204);//==
        //private static Color _imageMargin = Color.Red;//CHECK
        private static Color _menuBorder = DesignHelper.DoGetColorFromHash("Menu_menuBorder");// Color.FromArgb(255, 255, 255);//==
        //private static Color _menuBorder = Color.DarkGreen;
        private static Color _overflowBegin = Color.FromArgb(167, 204, 251);
        private static Color _overflowEnd = Color.FromArgb(101, 147, 207);
        private static Color _overflowMiddle = Color.FromArgb(167, 204, 251);
        private static Color _menuToolBack = Color.FromArgb(191, 219, 255);
        ...
        private static Color _toolStripBorder = Color.FromArgb(111, 157, 217);
        private static Color _toolStripContentEnd = Color.FromArgb(164, 195, 235);
        //private static Color _toolStripBegin = Color.FromArgb(227, 239, 255);//CHECK COMBO BLUE
        private static Color _buttonBorder = Color.FromArgb(121, 153, 194);
        #endregion
